...
| Read | When |
|---|---|
| `normalize_then_sum.md` | Core shared-weight optimizer hypothesis: call-site normalization, distance weighting, update-scale alignment, and relative-distance grouping for multiple losses. |
