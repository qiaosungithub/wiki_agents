...
`HANDOFF_<line_name>.md` (underscores).** This directory is only a pointer; do
not add handoff docs here.
...
here, and nowhere else"), added after a survey found ~200 handoff files
scattered across 130 directories.
