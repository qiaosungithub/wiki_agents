...
3. Read `wiki_agents/research/result_logging.md`.
4. Read `wiki_agents/projects/vlm_training.md`.
5. Read `wiki_agents/projects/vlm_data.md` if the task touches dataset locality
   or eval reruns; checkpoint provenance now lives in
   `projects/vlm_training.md` §Checkpoints, Stage Boundaries, Final Eval.
