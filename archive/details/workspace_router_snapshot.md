...
| Read a paper for the user / write a deep-reading report | `paper_reading.md` |
...
| `paper_reading.md` | Deep-reading report spec: required sections + arXiv figure/PDF pipeline. |
